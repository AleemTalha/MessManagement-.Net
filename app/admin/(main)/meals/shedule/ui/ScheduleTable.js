...
export default function ScheduleTable({ days, schedule, getDaySchedule, onEditDay }) {
  ...
  const MealCard = ({ meal }) => (
    <div className="shrink-0 w-64 bg-white border border-slate-200 rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow">
  ...
  return (
    <div className="bg-white rounded-sm overflow-hidden border">
